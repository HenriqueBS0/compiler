...
class OperacaoLogicaOr extends Node {
    ...
    public function setOperacaoLogicaOr(OperacaoLogicaOr $operacaoLogicaOr) : void
    {
        foreach ($operacaoLogicaOr->getSimbolos() as $simbolo) {
    ...
    private function validarVariavel(AnalisadorSemantico $analisadorSemantico, Token $variavel) : void
    {
        ...
        $this->verificarVariavelTipoBoleana($analisadorSemantico, $variavel);
    ...
    private function verificarVariavelTipoBoleana(AnalisadorSemantico $analisadorSemantico, Token $variavel) : void
    {
        $nomeVariavel = $variavel->getLexeme();
